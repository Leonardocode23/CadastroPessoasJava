                    ...
                    do {
                        ...
                        switch (opcaoPf){
                            case 1:
                                ...
                                novapf.dataNascimento = String.valueOf(date);
                            ...
                            case 2:
                                ...
                                if(listaPf.size() > 0){
                                    ...
                                    for (PessoaFisica cadaPf : listaPf){
                                        ...
                                        System.out.println("Data de Nascimento: " + cadaPf.dataNascimento.format(String.valueOf(DateTimeFormatter.ofPattern("dd/MM/yyyy"))));
                    ...
                    do {
                        ...
                        switch (opcaoPj){
                            case 1:
                                ...
                                novoEndPj.enderecoComercial = endCom.equalsIgnoreCase("S");
